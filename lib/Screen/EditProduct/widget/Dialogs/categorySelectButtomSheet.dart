                                                                      ...
                                                                      children: [
                                                                        InkWell(
                                                                          onTap:
                                                                            ...
                                                                            if (!item4!.state!) {
                                                                              update();
                                                                              editProvider!.selectedCatName = item4.name;
                                                                              editProvider!.selectedCatID = item4.id;
                                                                            }
                                                                          },
                                                                          child:
                                                                              Row(
                                                                                        ...
                                                                                        InkWell(
                                                                                          ...
                                                                                          child: Row(
                                                                                            children: [
                                                                                              ...
                                                                                              Text(
                                                                                                item5.name!,
                                                                                                style: TextStyle(color: !item5.state! ? black : grey),
                                                                                              ),
                                                                                            ],
                                                                                          ),
                                                                                        ),
