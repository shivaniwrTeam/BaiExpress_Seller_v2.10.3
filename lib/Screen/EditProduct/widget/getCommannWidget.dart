      ...
      child: TextFormField(
          ...
          FocusScope.of(context).requestFocus(
            () {
              if (index == 1) {
                ...
                return editProvider!.weightFocus;
              } else if (index == 23) {
                return editProvider!.heightFocus;
              } else if (index == 24) {
                return editProvider!.breadthFocus;
              } else if (index == 25) {
                return editProvider!.lengthFocus;
              }
            }(),
          );
        },
        ...
        controller: () {
          if (index == 1) {
            ...
            // } else if (index == 20) {
            //   return editProvider!.simpleProductBarcodeController;
            // } else if (index == 21) {
            //   return editProvider!.returnableDaysController;
          } else if (index == 22) {
            return editProvider!.weightController;
          } else if (index == 23) {
            return editProvider!.heightController;
          } else if (index == 24) {
            return editProvider!.breadthController;
          } else if (index == 25) {
            return editProvider!.lengthController;
          }
        }(),
        ...
        onChanged: (value) {
          if (index == 1) {
            ...
            // } else if (index == 20) {
            //   editProvider!.simpleProductBarcode = value;
            // } else if (index == 21) {
            //   editProvider!.returnableDays = value;
          } else if (index == 22) {
            editProvider!.weight = value;
          } else if (index == 23) {
            editProvider!.height = value;
          } else if (index == 24) {
            editProvider!.breadth = value;
          } else if (index == 25) {
            editProvider!.length = value;
          }
        },
        validator: (val) => () {
          if (index == 1) {
